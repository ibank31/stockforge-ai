...
export async function onRequestPost(context) {
  try {
    ...
    await recordEvent(env, job.id, "human_approval", "APPROVED", "approved", "Human review approved the asset for packaging.", { reviewer: "human", rights_and_release_reviewed: true, ai_disclosure_reviewed: true });
