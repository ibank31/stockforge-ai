...
**Updated:** 2026-08-25
**Branch:** `main`
**Latest GitHub documentation commit:** `41034fb`
**Deployed Space commit:** `935faa5` (runtime `RUNNING`, domain `READY`)
**Local packaging fix:** prepared after the single trial; not yet deployed
