...
**Updated:** 2026-08-25
**Branch:** `main`
**Latest GitHub commit:** `e082695` plus an uncommitted follow-up context-routing correction
**Deployed Space commit:** `935faa5` (runtime `RUNNING`, domain `READY`)
**Local packaging fix:** corrected to read `pre_gpu_gate.format_route`; not yet committed or synchronized
