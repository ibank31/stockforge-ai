...
**Updated:** 2026-08-24
**Branch:** `main`
**Latest verified commit:** `678d4a6` (nine-lane JPEG identity framework plus status sync committed and pushed; screenshot research pending)
...
1. Mature the JPEG route before any routine generation: evaluate the new `Technical Mechanical Component Illustrations` hypothesis against the existing nine lanes, select one globally researched buyer job, strengthen the scene prompt/layout contract, and keep one-candidate evidence rules.
